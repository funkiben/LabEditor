...
public class LabEditor extends LabFrame {
	...
	public LabEditor() {
		...
		componentWindow = new EditorWindow("Component Picker", 300, 400);
		componentWindow.getContent().addChild(new ComponentPicker(300, 400));
		componentWindow.setOffsetY(45);
		componentWindow.setMinWidth(300);
		componentWindow.setMinHeight(400);
